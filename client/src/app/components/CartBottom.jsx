...
const CartBottom = () => {
  ...
  return (
    <>
        ...
        <div className='px-6 py-3 lg:py-6 mt-auto'>
          ...
          <div className='flex  flex-col gap-y-3'>
            <button
              ...
              className='btn btn-lg gradient fonr-font-semibold flex justify-center'
            >
              Checkout
            </button>
          </div>
      ...
      {modal && (
        <Modal
          className='bg-white w-full h-full lg:max-w-[900px] lg:rounded-[30px] lg:fixed lg:top-[50%] lg:left-[50%] lg:translate-x-[-50%] lg:translate-y-[-50%] outline-none'
          isOpen={modal}
          style={modalStyles}
          onRequestClose={closeModal}
          constentLabel='Chechout Modal'
        >
          {/* close modal icon */}
          <div 
          onClick={closeModal}
