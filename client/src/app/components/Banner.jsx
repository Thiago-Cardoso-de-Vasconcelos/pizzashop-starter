      ...
      <div className='container mx-auto min-h-[768px] flex items-center justify-center'>
        ...
        >
          ...
          <MouseParallaxChild factorX={0.1} factorY={0.2}>
            <div className=' flex flex-col lg:flex-row justify-between items-center text-center lg:text-start text-white'>
              <div className='flex-1'>
                <div className='font-bangers text-[32px] text-white uppercase trancking-[0.03em]'>
                  Best pizza in town
                </div>
          ...
          <MouseParallaxChild factorX={0.2} factorY={0.3} className='relative'>
            {/* pizza image */}
            <div className='flex flex-col lg:flex-row items-center text-center flex-1 px-6'>
            ...
            <MouseParallaxChild
              factorX={0.3}
              factorY={0.6}
              className='absolute top-[26rem] left-15 hidden xl:flex'
            >
              <Image
                src={'/garlic-3.png'}
                width={100}
            ...
            <MouseParallaxChild
              factorX={0.4}
              factorY={1}
              className='absolute top-[23rem] left-14 hidden xl:flex'
            >
              <Image
                src={'/garlic-2.png'}
                width={100}
            ...
            <MouseParallaxChild
              factorX={0.2}
              factorY={0.2}
              className='absolute top-[27rem] left-16 hidden xl:flex'
            >
              <Image
                src={'/leaves.png'}
                width={160}
